...
★ **말투도 지시에 박는다** (2026-09-15). 안 박았더니 2026-09-15 보고서가
  1~3절은 «잘 돌았다» 반말, 4절은 «좋습니다» 존댓말로 섞였다. 토막을
  따로 보내므로 토막마다 말투를 제 나름대로 고른다. 전부 합니다체로 둔다.
"""
...
## 말투
- **모든 문장을 존댓말(합니다체)로 끝낸다.** 「~다」「~했다」「~아니다」
  「~마라」 같은 반말을 한 문장도 섞지 마라. 요약·목록·표 칸 안의 문장도
  똑같다. 예: 「배치가 잘 돌았다」 -> 「배치가 잘 돌았습니다」,
  「두 번째 경고로 세지 마라」 -> 「두 번째 경고로 세지 마세요」
